...
const DashboardComp = () => {
    const testmsg = [
        { response: 'I am a bot, I am here to help yochcfnfvh    gfhghghng nfghcfjghjmjhvmkvhjmkhjvjmjhvjhmhvu!dsgdaffffffffffffffffffffffffffffrg', 
            detail: 'More details',
        ...
        { response: 'I am afgncgnjxdf fvcsdffdfdfgg!', 
            detail: 'More details..',
            image: '' },
     ];
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center m-2">
            ...
            <div className="w-full h-[calc(89vh)] flex flex-col justify-between 
                shadow-custom-bottom rounded-lg bg-[rgb(16,23,42)] mb-10">
                {isLoading && (
